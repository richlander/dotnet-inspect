...
public class MetadataDeclarationSessionSubstrateTests
{
    ...
    public void PostedResultShapes_DoNotCarryLiveAuthority()
    {
        ...
        [
            ...
            typeof(MetadataAccessorDeclarationEvidence),
            typeof(MetadataAccessorSemanticsOccurrence),
            typeof(MetadataAccessorDeclarationFailure),
            typeof(MetadataAccessorDeclarationResult.Posted),
            typeof(MetadataAccessorDeclarationResult.Rejected),
