...
/// <summary>
/// Metadata-level guards for platform-provenance checks. These author exact metadata
...
/// </summary>
public sealed class MetadataProvenanceTests
{
    ...
    public void GenuinePlatformTypeSpecification_IsTrusted()
    {
        var image = BuildImage(
            ...
            typeName: "MemoryMarshal",
            scopeName: "System.Memory",
    ...
    public void DuplicateSimpleName_SpoofScopeViaTypeSpecification_Declines()
    {
        ...
        var image = BuildImage(
            ...
            decoyName: "System.Memory",          // signed decoy, same simple name, added first
