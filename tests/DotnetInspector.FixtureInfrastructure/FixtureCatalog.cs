...
public static class FixtureCatalog
{
    ...
    static string RepositoryProjectDirectory(string projectName)
        => projectName switch
        {
            "DiffAsmFixtures.Caller" => "src/DiffAsmFixtures.Caller",
            "DiffAsmFixtures.LibA" => "src/DiffAsmFixtures.LibA",
            "DiffAsmFixtures.LibB" => "src/DiffAsmFixtures.LibB",
            "DiffAsmFixtures.Target" => "src/DiffAsmFixtures.Target",
            "DiffFixtures.V1" => "src/DiffFixtures.V1",
            "DiffFixtures.V2" => "src/DiffFixtures.V2",
