...
public class SourceForwarderResolutionTests
{
    ...
    public async Task ApiServices_RetainsSelectedForwarderDescriptor()
    {
        ...
        try
        {
            ...
            ApiType targetType = Assert.Single(
                ...
                static type =>
                    type.FullName
                    == "DotnetInspect.Cli.Tests.SourceForwarderResolutionTests");
    ...
    [Fact]
    public async Task TypeWholeTypeDecompilerAcquisition_ReportsUnavailableMemorySafetyMode()
    {
        string directory = CreateDirectory();
        try
        {
    ...
    static string WriteUnsupportedMemorySafetyAssembly(string directory)
    {
