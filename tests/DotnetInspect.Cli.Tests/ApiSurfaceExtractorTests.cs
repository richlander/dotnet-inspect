...
public class ApiSurfaceExtractorTests
{
    ...
    public void Extract_RendersEnumParameterDefaultsAsEnumLiterals()
    {
        ...
        Assert.Contains("DotnetInspect.Cli.Tests.SampleColor color = DotnetInspect.Cli.Tests.SampleColor.Green", green.Signature);

        var zero = testType.Members.FirstOrDefault(m => m.Name == nameof(SampleEnumDefaultHost.Zero));
        Assert.NotNull(zero);
        Assert.Contains("DotnetInspect.Cli.Tests.SampleColor color = DotnetInspect.Cli.Tests.SampleColor.Red", zero.Signature);

        var unnamed = testType.Members.FirstOrDefault(m => m.Name == nameof(SampleEnumDefaultHost.Unnamed));
        Assert.NotNull(unnamed);
        Assert.Contains("DotnetInspect.Cli.Tests.SampleFlags flags = (DotnetInspect.Cli.Tests.SampleFlags)3", unnamed.Signature);
    }
    ...
    public void PopulateDerivedTypes_FindsDerivedClasses()
    {
        ...
        Assert.Contains("DotnetInspect.Cli.Tests.SampleDerivedClass", baseType.DerivedTypes);
        Assert.Contains("DotnetInspect.Cli.Tests.AnotherDerivedClass", baseType.DerivedTypes);
    }
    ...
    public void PopulateDerivedTypes_FindsInterfaceImplementors()
    {
        ...
        Assert.Contains("DotnetInspect.Cli.Tests.SampleImplementation", interfaceType.DerivedTypes);
    }
