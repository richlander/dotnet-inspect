...
public partial class CommandExecutionTests
{
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Amazon.Extensions.Configuration.SystemsManager", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.Extensions.Configuration.Json", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.Extensions.Configuration.UserSecrets", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.Extensions.Configuration.Binder", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.Extensions.Options.ConfigurationExtensions", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Scrutor", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "ReHackt.Extensions.Options.Validation", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.AspNetCore.Diagnostics.HealthChecks", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "App.Metrics.Extensions.Hosting", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Swashbuckle.AspNetCore.Annotations", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Serilog.Sinks.OpenTelemetry", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "OpenIddict.Validation.AspNetCore", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.AspNetCore.Components.Authorization", "-S", "Integrations", "--rows", "20");
    ...
    public async Task LibraryCommand_AuthenticationIntegration_ForGraphQlPackages_ShowsAuthorizationBuilderApis()
    {
        var (hotChocolateExit, hotChocolateOutput, hotChocolateError) = await RunAppAsync(
            "package", "HotChocolate.Authorization", "-S", "Integrations", "--rows", "20");
        var (graphQlExit, graphQlOutput, graphQlError) = await RunAppAsync(
            "package", "GraphQL.Authorization", "-S", "Integrations", "--rows", "20");
    ...
    public async Task LibraryCommand_DiscoverIntegrationsCategory_ListsUnifiedSection()
    {
        var (exit, output, error) = await RunAppAsync(
            ...
            "--effective", "--namesake-library", "--table");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.Extensions.AI", "-S", "@Integrations", "--rows", "80");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.Extensions.AI.Abstractions", "-S", "Integrations", "--rows", "80");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Serilog.Extensions.Logging", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.Extensions.Azure", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.AspNetCore.Authentication", "-S", "Integrations", "--rows", "40");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.AspNetCore.Authorization", "-S", "Integrations", "--rows", "40");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Microsoft.AspNetCore.OpenApi", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Serilog.AspNetCore", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Hangfire.AspNetCore", "-S", "Integrations", "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "library", "Azure.Extensions.AspNetCore.DataProtection.Blobs@1.5.3",
            "-S", "Integrations",
            "--where", "integration=integration.aspnetcore",
            "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "library", "Azure.Extensions.AspNetCore.DataProtection.Keys@1.6.3",
            "-S", "Integrations",
            "--where", "integration=integration.aspnetcore",
            "--rows", "20");
    ...
    {
        var (exit, output, error) = await RunAppAsync(
            "package", "Azure.Monitor.OpenTelemetry.Exporter", "-S", "Integrations", "--rows", "30");
