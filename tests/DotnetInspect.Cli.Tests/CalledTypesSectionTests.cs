...
public class CalledTypesSectionTests
{
    ...
    public async Task TypeCalledTypes_AggregatesOutboundCalleeTypes()
    {
        ...
        Assert.Contains("`DotnetInspect.Cli.Tests.CalledTypesDependency`", result.Output);
        Assert.Contains("| DotnetInspect.Cli.Tests | 3 | 2 | direct |", result.Output);
    ...
    public async Task TypeCalledTypes_UsesOpenGenericTypesAndExcludesGenericSelfCalls()
    {
        ...
        Assert.DoesNotContain("`DotnetInspect.Cli.Tests.CalledTypesGenericFixture", result.Output);
    ...
    public async Task TypeCalledTypes_TsvUsesPlainAggregateColumns()
    {
        ...
        Assert.Contains("DotnetInspect.Cli.Tests.CalledTypesDependency\tDotnetInspect.Cli.Tests\t3\t2\tdirect", result.Output);
    }
