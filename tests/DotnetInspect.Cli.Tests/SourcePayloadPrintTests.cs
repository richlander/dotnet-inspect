...
public sealed class SourcePayloadPrintTests
{
    ...
    [Theory]
    [InlineData(SectionNames.CostOverlay, "--format=json")]
    [InlineData(SectionNames.CostOverlay, "--format=jsonl")]
    [InlineData(SectionNames.CostOverlay, "--json-array")]
    [InlineData(SectionNames.SemanticsOverlay, "--format=json")]
    [InlineData(SectionNames.SemanticsOverlay, "--format=jsonl")]
