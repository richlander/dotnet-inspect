...
public class MarkoutRowContainmentTests
{
    ...
    [
        ...
        "FactRow.CsLine",
        "FactRow.Detail",
        "FactRow.EvidenceLocations",
        "FactRow.EvidenceState",
        "FactRow.EvidenceSubject",
        "FactRow.IL",
        "FactRow.Id",
        "FactRow.Member",
    ...
    {
        var assembly = typeof(DotnetInspect.Cli.Views.LibraryInspectionView).Assembly;
        ...
        Assert.True(
            checkedPropertiesByType.GetValueOrDefault(typeof(DotnetInspect.Cli.Views.InspectionResultView)) >= 10,
        ...
        Assert.Equal(
            ...
            checkedPropertiesByType.GetValueOrDefault(
                typeof(DotnetInspect.Cli.Views.PackageSourceAvailabilitySection)));
        Assert.Equal(
            6,
            checkedPropertiesByType.GetValueOrDefault(
