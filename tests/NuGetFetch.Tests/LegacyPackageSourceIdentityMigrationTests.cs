...
public sealed class LegacyPackageSourceIdentityMigrationTests
{
    ...
    public void LegacyPackageSourceIdentitySurfaceMatchesMigrationSet()
    {
        ...
        [
            ...
            new(
                "#4797",
                "tests/DotnetInspector.Services.Tests/PackagePayloadAcquisitionTests.cs",
            ...
            new(
                "#4805",
                "inspect-web/DotnetInspect.Web.Tests/BrowserEngineBoundaryTests.PackageVersionSettlement.cs",
                ExplicitReferences: 3,
                ImplicitReferences: 0),
        ];
