...
public sealed class BrowserCloneCandidateTransportTests
{
    ...
    sealed class Fixture : IAsyncDisposable
    {
        ...
        {
            string resultJson =
                await DotnetInspect.Web.Interop.Analysis.AnalysisExports.QueryCloneCandidates(requestJson);
    ...
    sealed class ReferenceFixture : IAsyncDisposable
    {
            ...
            BrowserCloneCandidateDiscovery discovery)
        {
            var request = new BrowserCloneCandidateRequest(
                ...
                discovery);
            string json =
                await DotnetInspect.Web.Interop.Analysis.AnalysisExports.QueryCloneCandidates(
