...
public sealed class BrowserMetadataOperationsTests
{
    ...
    public void MetadataOverview_ProjectsProductQueryResult()
    {
        ...
        BrowserAssemblyMetadata result =
            Assert.IsType<BrowserAssemblyMetadata>(
                DotnetInspect.Web.Interop.Metadata.MetadataExports.ProjectMetadataAssembly(
    ...
    public void MetadataOverview_ProjectsRuntimeReadyToRunAndManifestRoot()
    {
        ...
        BrowserMetadataWindow window = DotnetInspect.Web.Interop.Metadata.MetadataExports.ProjectMetadataWindow(
            "System.Private.CoreLib.dll",
            table.Index,
        ...
        BrowserHeapListing heap = DotnetInspect.Web.Interop.Metadata.MetadataExports.ProjectHeapListing(
            "System.Private.CoreLib.dll",
            HeapKind.String,
    ...
    public void MetadataTableWindow_ProjectsTypedRowsAndCoverage()
    {
        ...
        BrowserMetadataWindow result =
            DotnetInspect.Web.Interop.Metadata.MetadataExports.ProjectMetadataWindow(
                "DotnetInspect.Web.Tests.dll",
    ...
    public void MetadataHeapListing_PreservesPartiality()
    {
        ...
        BrowserHeapListing result =
            DotnetInspect.Web.Interop.Metadata.MetadataExports.ProjectHeapListing(
                "DotnetInspect.Web.Tests.dll",
                HeapKind.String,
                query);
