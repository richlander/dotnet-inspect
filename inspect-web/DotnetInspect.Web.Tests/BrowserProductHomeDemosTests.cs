...
public sealed class BrowserProductHomeDemosTests
{
    ...
    {
        using var document = JsonDocument.Parse(DotnetInspect.Web.Interop.Catalog.CatalogExports.ListHomeDemos());
    ...
    public void ResolveHomeDemo_UnknownId_ReturnsNotFound()
    {
        ...
        using var legacy = JsonDocument.Parse(DotnetInspect.Web.Interop.Catalog.CatalogExports.ResolveHomeDemo("stj"));
        Assert.False(legacy.RootElement.GetProperty("found").GetBoolean());

        using var missingNull = JsonDocument.Parse(DotnetInspect.Web.Interop.Catalog.CatalogExports.ResolveHomeDemo(null!));
        Assert.False(missingNull.RootElement.GetProperty("found").GetBoolean());

        using var missingBlank = JsonDocument.Parse(DotnetInspect.Web.Interop.Catalog.CatalogExports.ResolveHomeDemo(" "));
    ...
    public void CatalogProjectionUsesEcosystemDescriptorMetadata()
    {
        ...
        using var document = JsonDocument.Parse(
            DotnetInspect.Web.Interop.Catalog.CatalogExports.ResolveHomeDemo(
    ...
    {
        using var document = JsonDocument.Parse(
            await DotnetInspect.Web.Interop.Catalog.CatalogExports.RunHomeDemo("not-a-demo"));
        ...
        using var missingNull = JsonDocument.Parse(
            await DotnetInspect.Web.Interop.Catalog.CatalogExports.RunHomeDemo(null!));
        Assert.False(missingNull.RootElement.GetProperty("found").GetBoolean());
    }
