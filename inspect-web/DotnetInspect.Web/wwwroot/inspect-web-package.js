...
export function cancelPackageActivity(operationId, reason) {
...
export async function queryPlatformMemberDocumentation(framework, platformVersion, assemblyName, platformPack, documentationId) {
...
export async function runPackageQuery(operationId, prefix, termsJson, maximumCandidates, maximumMatches, includePrerelease, initialMatchCredit, eventSink) {
