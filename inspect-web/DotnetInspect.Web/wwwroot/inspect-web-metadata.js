...
export function cancelLibraryApiDiff(operationId, reason) {
...
export async function queryTypeProjection(packageId, version, targetFramework, assemblyName, typeQueryId, typeDefinitionId, workspaceJson) {
