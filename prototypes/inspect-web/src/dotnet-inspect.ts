...
const initialState = {
  ...
  memberAnnotatedKey: "",
  memberAnnotatedMedia: { CSharp: true, Il: false },
...
function openAnnotatedSourceExplorer() {
  ...
  state.annotatedExplorer = createAnnotatedSourceExplorerState(context.result.document, {
    ...
    ...(state.memberAnnotatedActiveFactIds === null
      ? {}
      : { activeFactIds: state.memberAnnotatedActiveFactIds }),
...
function closeAnnotatedSourceExplorer() {
  ...
  state.memberAnnotatedActiveFactIds = [...state.annotatedExplorer.activeFactIds];
...
function bindAnnotatedSourceEntryEvents() {
  bindAnnotatedSourceEntry(document, {
    ...
    onOpen: openAnnotatedSourceExplorer,
  });
}
