...
function renderPackageDependencies() {
  ...
  if (state.packageDependenciesLoading && fresh) {
    return renderPackageDependenciesSurface(
      `<section class="document-section package-dependencies-state source-progress"><span class="loader"></span><h2>Reading dependencies…</h2><p>Parsing the package manifest.</p></section>`,
      "reading");
  }
  ...
  if (!groups.length) {
    return renderPackageDependenciesSurface(
      `${dependencyGroupNotice}<section class="document-section empty-document"><span class="large-glyph">◇</span><h2>No package dependencies</h2><p>The manifest declares no NuGet dependencies — a self-contained package.</p></section>`,
  ...
  return renderPackageDependenciesSurface(
    `${dependencyGroupNotice}${selector}${graphSection}${depList}`,
