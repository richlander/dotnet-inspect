...
/// and <see cref="AssemblyId"/> joins that asset to the descriptor carrying its metadata identity.
/// They are separate because neither is interchangeable with display text.
/// </summary>
