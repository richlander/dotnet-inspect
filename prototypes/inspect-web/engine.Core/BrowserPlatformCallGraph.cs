...
/// <summary>
/// Executes source-native Platform call graphs for browser facades.
/// </summary>
[SupportedOSPlatform("browser")]
internal static class BrowserPlatformCallGraph
{
    ...
    static async Task<BrowserCallGraphInfo> QueryAsync(
        string targetFramework,
        string platformVersion,
        string assembly,
        string pack,
    ...
    static async Task<PlatformGraphBuild> BuildAsync(
        string targetFramework,
        string platformVersion,
        string assembly,
        string pack,
    ...
    static async Task<PlatformMemberFocus> ResolveMemberAsync(
    ...
    static Analysis.CallGraphMemberResolution? TryResolveMember(
    ...
    static AssemblyReferenceIdentity[] RequiredAssemblies(
        CallGraphProjection projection,
        BrowserPlatformScope scope)
    {
