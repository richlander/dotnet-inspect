...
static class FidelityCheck
{
        ...
        out bool complete)
    {
        ...
        {
            // Receiver normalization erases generic arity; keep collisions incomplete
            // so extension roots flow through visible fallback instead of first-wins exclusion.
            complete = false;
