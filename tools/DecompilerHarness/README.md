...
*When to use it.* Track the structuring completeness with `--gaps`. Over CoreLib it currently reads ~96% fully raised, the residual dominated by `structuring: conditional-branch` (the forward-branch-to-common-exit work).
