...
public static class NuGetApi
{
    ...
    /// </summary>
    /// <remarks>
    /// A malformed document propagates as <see cref="JsonException"/>. A
    /// swallowed parse failure is indistinguishable from a genuine zero-result
    /// response, which turns a hard failure into success-shaped empty output.
    /// See issue #3417.
    /// </remarks>
