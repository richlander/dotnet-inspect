...
public static class MemberOptionsParser
{
    ...
    /// unchanged.
    /// </remarks>
    public record VersionError(DotnetInspect.Cli.Options.OptionError Error) : MemberParseResult;
        ...
        MemberCommandArgs args)
    {
        ...
        bool selectsCallRows =
            MemberCallRowSelectionAdoption.IsActive(
                parseResult,
                opts);
        ...
        var options = new MemberOptions
        {
            ...
            MarkdownExplicitlySet =
                opts.IsMarkdownOutput(parseResult),
