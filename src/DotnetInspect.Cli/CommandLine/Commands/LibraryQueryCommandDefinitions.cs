...
internal static class LibraryQueryCommandDefinitions
{
        ...
        Argument<string?> inheritedSourceArgument)
    {
        ...
        {
            Description =
                "Minified JSON (use with --format json or --envelope)",
        };
        ...
        command.Validators.Add(result =>
        {
            ...
            {
                result.AddError(
                    "--compact requires library query --format json or --envelope.");
            }
            ...
            {
                result.AddError(
                    "--tree with library query --format json requires schema discovery.");
            }
        });
