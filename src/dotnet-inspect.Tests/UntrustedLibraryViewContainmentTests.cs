...
public class LibraryViewShapeDerivedContainmentTests
{
    ...
    [
        ...
        "LibraryInspection.MetadataRoot (MetadataRootInspection): computed projection still null after the walk",
        ...
        "LibraryInspection.ReadyToRunOverview (ReadyToRunImageOverview): computed projection still null after the walk",
