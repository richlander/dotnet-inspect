...
public sealed class PackageIntegrationsWorkspaceTests
{
    ...
    [Fact]
    public async Task OpportunityDemand_ExecutesBeforeParticipantRelease()
    {
        string path =
