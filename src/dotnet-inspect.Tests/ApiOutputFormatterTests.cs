...
public class ApiOutputFormatterTests
{
    ...
    public void ApiPresentationRows_CarryConcernProvenance()
    {
        ...
        [
            ...
            member.KindText,
            member.NameText,
            member.ReturnTypeText.Evidence,
            member.DetailText.Evidence,
            type.KindText,
            type.TypeText,
            type.MembersText,
        ];
    ...
    public void ApiPresentationBuilders_PreserveConcernProvenance()
    {
        ...
        Assert.Equal(Concerns, member.ReturnTypeText.Evidence.Concerns);
        Assert.Equal(Concerns, member.DetailText.Evidence.Concerns);
