...
public class ApiCommand
{
    ...
    public static Task<int> ExecuteAsync(ApiOptions options) => options switch
    {
        ...
        _ => TypeCommand.ExecuteAsync(new TypeOptions
        {
            ...
            MermaidOutput = options.MermaidOutput, EmbeddedMermaid = options.EmbeddedMermaid,
            TabularExplicitlySet = options.TabularExplicitlySet,
            FormatExplicitlySet = options.FormatExplicitlySet, Format = options.Format,
            NoHeader = options.NoHeader, Bare = options.Bare, Tree = options.Tree,
            Limit = options.Limit, MemberLimit = options.Limit,
