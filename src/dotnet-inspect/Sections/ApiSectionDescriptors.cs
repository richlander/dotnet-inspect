...
public static class ApiMemberSectionDescriptors
{
    ...
    public static SectionPipeline<ApiType> CreatePipeline()
        => CreatePipeline(includeMemberInfo: false);

    /// <summary>Builds the section pipeline for the broad member-list view.</summary>
    public static SectionPipeline<ApiType> CreateBroadMemberPipeline()
        => CreatePipeline(includeMemberInfo: true);

    private static SectionPipeline<ApiType> CreatePipeline(bool includeMemberInfo)
    {
