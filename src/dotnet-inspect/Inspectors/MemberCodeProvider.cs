            ...
            var selection = bodySource.ResolveMethod(
                ...
                method.MetadataToken is { } sourceToken
                    ? ApiBodyMemberCorrespondence.Resolve(
                        ...
                        assembly,
                        request.ProjectAssetsPath,
                        request.TargetFramework,
                        request.PlatformFramework)[sourceToken]
                    : null);
