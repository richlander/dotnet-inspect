...
internal sealed class PackageInspectionJson
{
    ...
    internal static IReadOnlyDictionary<string, string> ProjectionAliases { get; } =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Native Dependencies"] = JsonNamingPolicy.SnakeCaseLower.ConvertName(nameof(HasNativeDependencies)),
            ["Readme"] = JsonNamingPolicy.SnakeCaseLower.ConvertName(nameof(HasReadme)),
            ["RID-Specific Assets"] = JsonNamingPolicy.SnakeCaseLower.ConvertName(nameof(HasRidSpecificAssets)),
