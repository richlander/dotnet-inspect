...
public sealed record BodyShapeRow(
    ...
    string Member,
    string Token,
    [property: MarkoutPropertyName("Start Line")] int StartLine,
    [property: MarkoutPropertyName("Start Column")] int StartColumn,
    [property: MarkoutPropertyName("End Line")] int EndLine,
    [property: MarkoutPropertyName("End Column")] int EndColumn,
    string Match)
{
