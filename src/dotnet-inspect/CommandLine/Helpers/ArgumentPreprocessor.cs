...
public static class ArgumentPreprocessor
{
    ...
    public static readonly HashSet<string> KnownCommands = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "package", "project", "library", "type", "member", "diff", "timeline", "graph", "find", "vocabulary", "source", "list", "ls", "skill", "demo", "extensions", "implements", "match", "depends", "dependency-evidence", "cache", "ecosystem", "workspace", "workspace-state", "help", "--help", "-h", "-?", "--version", "--flavor"
    };
