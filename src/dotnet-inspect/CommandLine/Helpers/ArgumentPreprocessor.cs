...
public static class ArgumentPreprocessor
{
    ...
    public static readonly HashSet<string> KnownCommands = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "package", "project", "library", "api", "type", "member", "diff", "find", "source", "build", "list", "ls", "skill", "extensions", "implements", "depends", "cache", "completion", "perf", "perf-test", "help", "--help", "-h", "-?", "--version", "--flavor"
    };
