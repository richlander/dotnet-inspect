...
public static class ArgumentPreprocessor
{
    ...
    {
        "package", "library", "api", "type", "member", "diff", "find", "samples", "list", "ls", "llmstxt", "skill", "extensions", "implements", "depends", "cache", "demo", "perf", "perf-test", "help", "--help", "-h", "-?", "--version", "--flavor"
    };
