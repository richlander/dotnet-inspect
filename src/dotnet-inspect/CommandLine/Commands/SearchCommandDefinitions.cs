...
public static class SearchCommandDefinitions
{
    public static Command CreateFindCommand(SharedOptions opts)
    {
        ...
        var typeFilterOption = new Option<string?>("-t") { Description = "Filter API types by glob (for example, -t *Json*)" };
    ...
    public static Command CreateImplementsCommand(SharedOptions opts)
    {
        ...
        var typeFilterOption = new Option<string?>("-t") { Description = "Filter types by glob (for example, -t *Json*)" };
        typeFilterOption.Aliases.Add("--type");
