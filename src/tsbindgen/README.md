...
replaces current public operation, enum, and DTO spelling collisions with
deterministic allocation from complete managed identities while keeping
genuinely illegal identifier input visible.
