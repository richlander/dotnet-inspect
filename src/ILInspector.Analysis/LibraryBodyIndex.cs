...
public sealed class LibraryBodyIndex
{
    ...
    sealed class IndexBuilder
    {
        ...
        static bool TryFindPreviousInstruction(DecodedBody decodedBody, int targetOffset, out DecodedInstruction previousInstruction)
        {
            ...
            return previousInstruction is not null && previousInstruction.NextOffset == targetOffset;
        }
        ...
        {
            access = default;
            int operand = OperandInt32(instruction);
            switch (instruction.OpCode)
            {
                ...
                case ILOpCode.Ldloc: access = new(operand, false, false); return true;
                ...
                case ILOpCode.Stloc: access = new(operand, false, true); return true;
                ...
                case ILOpCode.Ldarg_s:
                case ILOpCode.Ldarg: access = new(operand, true, false); return true;
                case ILOpCode.Starg_s:
                case ILOpCode.Starg: access = new(operand, true, true); return true;
                default:
                    return false;
            }
        }
