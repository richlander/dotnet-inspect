...
public abstract record ResourceEffectLocation
{
    ...
    public sealed record OperationSlot : ResourceEffectLocation
    {
    ...
    public sealed record StructuralField : ResourceEffectLocation
    {
            ...
            ResourceEffectMemberSelector selector)
        {
            ...
            {
                throw new ArgumentException(
                    "A structural field location must be rooted in receiver, parameter, or return.",
                    nameof(root));
            }
            if (selector.Kind != ResourceEffectMemberKind.Field)
                throw new ArgumentException("The structural selector must identify a field.", nameof(selector));
            Root = root;
            Selector = selector;
        }
...
public abstract record ResourceEffectCompletion
{
    ...
    public sealed record OutcomeCase : ResourceEffectCompletion
    {
        public OutcomeCase(
            ResourceEffectLocation source,
...
public sealed record ResourceEffectModelDefinition
{
    ...
    readonly ImmutableArray<ResourceEffectTypedDeclaration> _typedDeclarations;
    ...
    public ResourceEffectModelDefinition(
        ...
        ImmutableArray<ResourceEffectTypedDeclaration> typedDeclarations = default)
    {
        if (language == default)
        ...
        _typedDeclarations = typedDeclarations.IsDefault
            ? []
            : ImmutableArrayValueEquality.RequireInitialized(
                typedDeclarations,
                nameof(typedDeclarations));
        Language = language;
        Identity = identity;
    }
    ...
    public ImmutableArray<ResourceEffectTypedDeclaration> TypedDeclarations
        => _typedDeclarations;
}

public sealed class ResourceEffectTypedDeclaration
    : IEquatable<ResourceEffectTypedDeclaration>
{
    readonly ImmutableArray<ResourceDeclarationProvenance> _provenances;

    public ResourceEffectTypedDeclaration(
        ResourceEffectTargetSelector target,
        ...
        ImmutableArray<ResourceDeclarationProvenance> provenances)
    {
        ...
        _provenances =
            ImmutableArrayValueEquality.RequireInitialized(provenances, nameof(provenances));
        if (_provenances.IsEmpty)
            throw new ArgumentException("A typed declaration requires provenance.", nameof(provenances));
        Target = target;
        Effect = effect;
    }
    ...
    public bool Equals(ResourceEffectTypedDeclaration? other)
        => other is not null
            && Target == other.Target
            && Effect == other.Effect;

    public override bool Equals(object? obj)
        => obj is ResourceEffectTypedDeclaration other && Equals(other);

    public override int GetHashCode() => HashCode.Combine(Target, Effect);
}

public sealed class AdmittedResourceEffectDeclaration
    : IEquatable<AdmittedResourceEffectDeclaration>
{
    readonly ImmutableArray<ResourceDeclarationProvenance> _provenances;

    internal AdmittedResourceEffectDeclaration(
        ResourceEffectTargetSelector target,
        ResourceEffect effect,
        ImmutableArray<ResourceDeclarationProvenance> provenances)
    {
        ...
        _provenances =
            ImmutableArrayValueEquality.RequireInitialized(provenances, nameof(provenances));
        if (_provenances.IsEmpty)
            throw new ArgumentException("An admitted declaration requires provenance.", nameof(provenances));
        Target = target;
        Effect = effect;
    }
    ...
    public bool Equals(AdmittedResourceEffectDeclaration? other)
        => other is not null
            && Target == other.Target
            && Effect == other.Effect;

    public override bool Equals(object? obj)
        => obj is AdmittedResourceEffectDeclaration other && Equals(other);
