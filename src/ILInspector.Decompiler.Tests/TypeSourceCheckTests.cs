...
public class TypeSourceCheckTests
{
    ...
    public void Evaluate_OnExtractorFixtures_DoesNotReportEnumUnderlyingTypeDeltas()
    {
        ...
        var eventKeywordsSource = TypeSourceComposer.Compose(eventKeywords, path, pdbPath: null).Output;
        ...
        var securityRuleSetSource = TypeSourceComposer.Compose(securityRuleSet, path, pdbPath: null).Output;
        ...
        var dayOfWeekSource = TypeSourceComposer.Compose(dayOfWeek, path, pdbPath: null).Output;
    ...
    public void Evaluate_OnSequentialLayoutFixtures_RendersNonDefaultLayoutAttributes()
    {
        ...
        var packedSource = TypeSourceComposer.Compose(packed, path, pdbPath: null).Output;
        ...
        var classSource = TypeSourceComposer.Compose(sequentialClass, path, pdbPath: null).Output;
