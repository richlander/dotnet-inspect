...
public class AnnotationStructuredViewTests
{
    ...
    public void Json_CarriesTheFactWithItsOffsetForCrossReference()
    {
        ...
        Assert.Equal("int; alloc=boxed System.Int32; path=straight-line; path-confidence=dominates-return; post-dominance=return-post-dominates; escape=escapes; escape-kind=escapes-return", fact.GetProperty("detail").GetString());
    ...
    public void Json_IsValidEvenWithGenericDetailContainingAngleBracketsAndCommas()
    {
        ...
        Assert.Contains(doc.RootElement.EnumerateArray(),
            f => f.GetProperty("detail").GetString() == "Func<int, int>; alloc=System.Func<System.Int32, System.Int32>; path=straight-line; path-confidence=dominates-return; post-dominance=return-post-dominates; escape=escapes; escape-kind=escapes-return");
    }
