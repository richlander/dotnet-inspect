...
public class AnnotatedCSharpRendererTests
{
    ...
    public void Array_SurfacesTheAllocatedType()
    {
        ...
        Assert.Contains("// alloc.array(int[]; alloc=System.Int32[]; path=straight-line; path-confidence=dominates-return; post-dominance=return-post-dominates; escape=escapes; escape-kind=escapes-return; multiplicity=once)", output);
    }
