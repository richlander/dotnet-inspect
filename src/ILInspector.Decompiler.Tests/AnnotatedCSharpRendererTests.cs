...
public class AnnotatedCSharpRendererTests
{
    ...
    public void Box_SurfacesAsATrailingCommentOnTheReturn()
    {
        ...
        Assert.Contains("return x;  // alloc.box(int; alloc=boxed System.Int32; path=straight-line; path-confidence=dominates-return; post-dominance=return-post-dominates; escape=escapes; escape-kind=escapes-return)", output);
    }
    ...
    public void Array_SurfacesTheAllocatedType()
    {
        ...
        Assert.Contains("// alloc.array(int[]; alloc=System.Int32[]; path=straight-line; path-confidence=dominates-return; post-dominance=return-post-dominates; escape=escapes; escape-kind=escapes-return)", output);
    }
