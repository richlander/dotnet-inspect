...
public class MixedSourceRendererTests
{
    ...
    public void Fact_ShowsOnBothTheCSharpLineAndTheIlLine()
    {
        ...
        Assert.Contains("alloc.array(int[]; alloc=System.Int32[]; path=straight-line; path-confidence=dominates-return; post-dominance=return-post-dominates; escape=escapes; escape-kind=escapes-return)", cs);
        Assert.Contains("alloc.array(int[]; alloc=System.Int32[]; path=straight-line; path-confidence=dominates-return; post-dominance=return-post-dominates; escape=escapes; escape-kind=escapes-return)", il);
    }
