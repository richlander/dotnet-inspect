...
public class InverseArchitectureTests
{
    ...
    static readonly string[] EnforcedProductNodes = ["AddressOfMethod", "AnonymousObject", "ArrayLength", "ArrayLiteral", "AwaitExpression", "Binary", "Box", "Call", "CallIndirect", "CastClass", "CaughtException", "Coalesce", "Coerce", "CollectionExpression", "CollectionSpreadElement", "Comparison", "Conditional", "Constant", "Convert", "DelegateCreation", "IncrementDecrement", "IndexFromEnd", "InitializerBlock", "InlineArraySpanConversion", "InterpolatedStringExpression", "IsInstance", "IsPattern", "Lambda", "LoadArgument", "LoadArgumentAddress", "LoadElement", "LoadElementAddress", "LoadField", "LoadFieldAddress", "LoadFunctionPointer", "LoadIndirect", "LoadLocal", "LoadLocalAddress", "LoadProperty", "LoadStackSlot", "LoadToken", "LocalFunctionInvocation", "LogicalBinary", "LogicalNot", "NewArray", "NewObject", "NullConditional", "ObjectInitializerExpression", "PositionalPattern", "RangeExpression", "RecursivePropertyDeclarationPattern", "SingleElementListPattern", "SizeOf", "SliceExpression", "SpanLiteral", "StackAllocArray", "StackAllocate", "SwitchExpression", "TupleBinaryExpression", "TupleExpression", "TypeOf", "Unary", "Unbox", "UnboxAny", "UnionSwitchExpression", "UnsupportedNode", "WithExpression"];
