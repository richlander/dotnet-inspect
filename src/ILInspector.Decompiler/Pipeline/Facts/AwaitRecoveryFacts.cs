...
internal sealed class AwaitRecoveryFacts : ILoweringFactProvider
{
    ...
    [
        new(
            ...
            MissingDiscriminator: "classic async stage application requires an authenticated declared-kickoff request; within that request, Start and .Task-named return remain name-matched rather than builder-correlated"),
    ];
}
