    ...
    [
        new(
            ...
            [
                ...
                new FactPrimitive("assembly-identity:trusted-platform-expression-family", "the Expression factory calls resolve through a framework public-key-token (MethodRef.DeclaringTypeIsTrustedPlatform) and the delegate is the corelib System.Func family — not a name-forged lookalike Expression/Func in a user assembly"),
