...
dotnet-inspect project ./src/App -S "Skills" --print --row 1 --format jsonl
dotnet-inspect package Markout -S "Package skill files"
dotnet-inspect package Markout --path @agents --content --frontmatter
dotnet-inspect package Markout Polly --path @agents --path @readme --match first --content --format jsonl
```
