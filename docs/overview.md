...
- `src/ILInspector.Text/` provides the reusable `SourceTextDiff` API for exact, ordered line inspection and generic text comparison on the shared Finding spine.
