...
- [C# member recompilation and assembly patching](design/csharp-member-recompilation.md): proposed tools-only `cluster`/`all` artifact compilation, scoped IL/C# diffing, and bounded method-body transplantation.
