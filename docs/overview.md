...
- [Typed row-source execution](design/row-source-execution.md): source offer
  negotiation, accepted-execution receipts, completion-evidence binding, and
  exact upstream Count acceptance.
