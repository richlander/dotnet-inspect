...
- [Implementation Diff](design/implementation-diff.md): structured
  participant, body-target, work-item, mechanism, authored-source, and result
  lifecycle for the product C# + IL/body diff projection shared by the opt-in
  `diff` section, RTS, and harnesses.
