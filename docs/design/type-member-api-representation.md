...
| `AssemblyBindingDecision` | One terminal projection of a manifested binding question | Which exact frozen generation and policy version produced the binding classification, detached request, selected or inactive suppliers, miss disposition, and failure evidence | Continued binding, type lookup, or authority to reopen a supplier |
