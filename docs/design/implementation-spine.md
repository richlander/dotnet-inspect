...
| Pairwise direct-use acquisition | `AssemblyPairCallUseQuery` executes participant Analysis and consumes focused call-graph results | Reuse as the pairwise proof point for graph-wide census |
