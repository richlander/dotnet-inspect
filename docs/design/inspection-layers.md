...
manifest-resource, type-forwarder, union-type, classified-method, switch, SourceLink,
...
union-type, classified-method, switch, and SourceLink canaries, collection is
