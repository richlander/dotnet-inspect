...
| State | **Implemented** for `Settle`, `Acquire`, and target-aware `Realize`; pruning, dependency realization, live Library construction, Workspace handoff, and host adoption remain planned. |
