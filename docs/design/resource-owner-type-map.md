...
| State | **Implemented** for `Settle`, `Acquire`, target-aware `Realize`, and receipt-preserving package Root contribution. Configured-producer Root representation, live Library construction, Workspace admission, and host adoption remain planned. |
