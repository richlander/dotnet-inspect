...
| DocumentationHouse / Library | Compiled-XML core **implemented**; source/provider and host adoption **planned** | `DocumentationHouse.ExecuteAsync` consumes one `LibraryOperationLease`, borrows exact XML content synchronously, and settles before return | Materialized compiled documentation, typed attempts, failures, work evidence, and resource-free receipts | [DocumentationHouse](documentation-house.md), #6579 and #6621 slice 8 |
