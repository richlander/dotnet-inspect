...
The nested-initializer gate retains its complete async body and existing
DEC0008, independently of its successful compile-back; this owner does not
repair the unrelated unknown-type diagnostic.
