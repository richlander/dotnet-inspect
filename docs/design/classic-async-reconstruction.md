...
implements the corresponding `IAsyncStateMachine` member. This
classification reads no sibling body and remains present under
...
pre-decision normalization. A generated MethodDef with exact
