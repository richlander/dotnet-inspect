...
| --- | --- | --- | --- |
| `package X` | What is this package, and what does it ship? | `Package Info`, `Package library files` | Identity/metadata plus asset shape answer most package triage questions without a dependency inventory. |
