...
An abandoned response ends its transfer: the step reads at most 64 KiB that
has already arrived, then closes its connection rather than letting the HTTP
handler drain the unread body to reuse it.
