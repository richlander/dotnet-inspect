...
[row-source execution](row-source-execution.md) design owns how that
...
[row-source execution](row-source-execution.md) contract applies its
...
The
[row-source execution](row-source-execution.md) contract owns the
