...
existing umbrella design. The stacked composition map adopts this component and
retires the umbrella assignment. The current product does not implement this
contract.
