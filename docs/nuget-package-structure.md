...
- `PackageAssetSelectorTests.SelectMatchingFramework_IgnoresNewerCompatibleUniverse`;
- `PackageAssetSelectorTests.SelectMatchingFramework_RejectsDistinctAliasUniverses`;
- `PackageAssemblyContextRealizationTests.PackageRootBinding_CompatibleEmptyGroupSuppressesCompileFallback`;
- `PackageAssemblyContextRealizationTests.CompatibleFrameworkAlias_ReacquisitionPreservesSelectedUniverse`;
- `PackageAssemblyContextRealizationTests.CompatibleFrameworkAlias_ReacquisitionRejectsDifferentReplacementTarget`;
- `PackageAssemblyContextRealizationTests.CompatibleFrameworkAlias_ReacquisitionKeepsRetainedFrozenTarget`;
- `PackageAssemblyContextRealizationTests.CompatibleFrameworkAlias_EqualCanonicalTargetRejectsReplacement`;
- `PackageAssemblyContextRealizationTests.CompatibleUnresolvedSelection_ReacquisitionCanSelectReplacementUniverse`;
- `PackageAssemblyContextRealizationTests.CompatibleRidAmbiguity_ReacquisitionRemainsUnresolved`;
- `PackageAssemblyContextRealizationTests.CompatibleFrameworkAliases_ReacquisitionRemainsInvalid`;
