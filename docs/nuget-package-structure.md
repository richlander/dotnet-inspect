...
- `PackageAssetSelectorTests.SelectCanonicalFramework_IgnoresNewerCompatibleUniverse`;
- `PackageAssetSelectorTests.SelectCanonicalFramework_RejectsDistinctAliasUniverses`;
