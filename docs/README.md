...
| [Member Inspection Planning and Metadata Projection](design/member-inspection-planning-and-metadata-projection.md) | Accepted ownership, planning, projection, migration, and replacement architecture for member inspection. |
| [Member Inspection Migration Disposition](design/member-inspection-migration-disposition.md) | Frozen implementation and evidence assignments for the accepted member-inspection migration. |
