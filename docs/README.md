...
| [Typed Row-Source Execution](design/row-source-execution.md) | Source offer negotiation, acceptance receipts, completion-evidence binding, row handoff, and exact upstream Count acceptance. |
