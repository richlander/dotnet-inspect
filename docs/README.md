...
| [Repository CI Change Plan](design/ci-change-plan.md) | Typed candidate provenance, exact changed-path interpretation, immutable CI job selection, scoped evidence, and visible planner refusal. |
