...
| [Portable Query Payload](design/portable-query-payload.md) | The single byte spelling of a query intent, as principles in prose over a vectors file that gates the codec in `DotnetInspector.PortableQueries`. |
