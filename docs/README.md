...
| [Annotated Source Interaction Model](design/annotated-source-interaction-model.md) | Browser reading, exploration, chips, defaults, navigation, focus, and progressive-disclosure contract for Annotated Source. |
