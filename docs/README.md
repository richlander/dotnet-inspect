...
| [Custom-Attribute Value Decoding](design/custom-attribute-value-decoding.md) | The alignment and bounding invariants relating the custom-attribute value guard to SRM's decode, the two width-resolution paths, bounds, charging, and refusal semantics. |
