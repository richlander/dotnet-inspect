...
| [Ecosystem CLI](design/ecosystem-cli.md) | The `ecosystem` command: how the product-owned ecosystem registry is rendered as sections, with each ecosystem as a domain category. |
