...
| [Annotated Source Finding Provenance](design/annotated-source-finding-provenance.md) | Audited Annotated Source descriptor catalog, local/remote evidence coordinates, browser behavior, and fidelity blockers. |
