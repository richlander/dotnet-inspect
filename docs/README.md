...
| [C# Structured Declaration Provenance](design/csharp-structured-declaration-provenance.md) | CSharp-owned declaration-slot classification, representability, evidence-preserving fallback/degradation, and failure contract. |
