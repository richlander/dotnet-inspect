...
| [Portable Query Payload](design/portable-query-payload.md) | The single byte spelling of a query intent: canonicalization, the closed JSON schema, pinned tokens and tuple shapes, declared limits, and the share-packet query payload. |
