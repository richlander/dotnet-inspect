...
| [Inspect Web SlideStrip](design/inspect-web-slide-strip.md) | Reusable single-region ordered-item control with label, short-label, and icon policies, finite representation states, internal sliding, and focus preservation. |
