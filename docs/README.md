...
| [Structural Clone Search Scope](design/structural-clone-search-scope.md) | Shared Library/Type/Member seed populations and three-step Workspace candidate focal length, with name-filtered middle default. |
