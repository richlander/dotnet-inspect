...
| [Inspect Web Library API Diff](design/inspect-web-library-api-diff.md) | Package-targeted Library public-API comparison, metadata-facade projection, master/detail state, and atomic retirement of the transient Source Diff modal. |
