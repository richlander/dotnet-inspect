...
| [Build Event Log Inspection](design/build-event-log.md) | Desired `dotnet-inspect build` architecture, standalone JSONL reader, EventLogId resolution, and initial build views. |
