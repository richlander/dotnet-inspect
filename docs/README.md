...
| [Resource-Owner Type Map](design/resource-owner-type-map.md) | Non-normative current-state index of owner-issued resources, operation authority, borrows, resource-free evidence, maturity, gates, and future compiler correspondence. |
