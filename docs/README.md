...
| [Assembly Dependency Candidate Discovery](design/assembly-dependency-candidate-discovery.md) | Services-owned discovery before simple-name selection, with RTS consumer adoption and legacy-retirement tracking. |
