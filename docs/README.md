...
| [NuGet Feed Authentication](design/nuget-authentication.md) | How feeds are authenticated, which credential mechanisms are honored and which are silently ignored, and the hermetic/live test tiers. |
