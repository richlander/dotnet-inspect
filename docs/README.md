...
| [Inspect Web Diff Presentation](design/inspect-web-diff-presentation.md) | Typed source-comparison consumption, Markout mapped-range rendering, unified and side-by-side interaction, large-input bounds, and staged multi-subject adoption. |
