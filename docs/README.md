...
| [Browser comparison targets](design/inspect-web-comparison-targets.md) | Package-scoped browser Diff and Clone target settings, defaults, and subject-navigation inheritance. |
