...
| [Resource Ownership and Borrowing](design/resource-ownership-and-borrowing.md) | Host-neutral semantics for exclusive mutable values, terminal resources, transfer, direct and snapshot-callback borrowing, detached immutable results, release, and current-versus-future enforcement. |
