...
| Resource ownership and current adoption | [Resource Ownership and Borrowing](design/resource-ownership-and-borrowing.md), [Resource Occurrence Analysis](design/resource-occurrence-analysis.md), [Resource Lifecycle Analysis](design/resource-lifecycle-analysis.md), and the [Resource-Owner Type Map](design/resource-owner-type-map.md) |
