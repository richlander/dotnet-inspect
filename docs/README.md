...
| [Bounded Metadata Signature Decoding](design/metadata-signature-decoding.md) | The independent node, materialization, and work-ledger bounds for decoding one artifact-authored metadata signature. |
