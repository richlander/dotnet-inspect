...
| Query operation registration, portable intent, and payload | [Query Operation Infrastructure](design/query-operation-infrastructure.md), [Library Query](design/library-query.md), [Portable Query Intent](design/portable-query-intent.md), and [Portable Query Payload](design/portable-query-payload.md) |
