...
| [Member Source Diff Presentation](design/member-source-diff-presentation.md) | Canonical standalone endpoint projection, AnalysisDiff statistics, Markout lowering, and first adoption by CLI Source Diff. |
