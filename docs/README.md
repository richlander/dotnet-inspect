...
| [Metadata Semantic Substrates](design/metadata-semantic-substrates.md) | Admission test, outcome vocabulary, identity and lifetime rules for Metadata components that authenticate higher-level meaning for several independent consumers. |
