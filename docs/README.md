...
| [Classic Async Stage Application](design/classic-async-stage-application.md) | Preserves exact execution/support hosts and admits only declared kickoffs to inverse-driven mutation. |
