...
| [Stateless Core Services](design/stateless-core-services.md) | Target composition with resource-free Workspace definitions, one active runtime, explicit request authority, detached envelopes, and admitted persistent caching. |
