...
| [Reverse Type-Declaration Locator](design/reverse-type-declaration-locator.md) | Proposed finite-population declaration query preserving exact Library coordinates, structured names, definition/forwarder evidence, observation contexts and completeness without selecting a binding. |
...
| [Inspect Web Runtime Performance Evidence](inspect-web-runtime-performance.md) | Matched-head nightly production-site latency and throughput evidence for the Mono baseline, .NET 12 CoreCLR, and CoreCLR ReadyToRun. |
