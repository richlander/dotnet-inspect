...
| [Portable Query Intent](design/portable-query-intent.md) | The single serializable query layer: canonical vocabulary/key/operator/value terms plus typed bounds, atomic resolution that starts no work, and the share-packet query payload. |
