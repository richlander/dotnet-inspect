...
and [#4830](https://github.com/richlander/dotnet-inspect/pull/4830)
record runs against the pinned `v1.8.0` prerelease `tla2tools.jar` exactly
(TLC `2026.08.21.155922`, rev `9787e65`); #4838's recorded TLC version
predates that pin and was not re-verified against it as part of writing this
runbook.
