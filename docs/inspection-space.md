...
Product-resident home demos ship as a static API registry
(`DotnetInspector.Queries.Definitions.ProductInspectionDemos`); hosts activate
them by scenario id through `ProductInspectionDemos.ResolveHomeScenario` or
`InspectionDefinitionRegistry.ResolveScenario`.
