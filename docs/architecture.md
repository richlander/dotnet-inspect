...
| Target `PlatformHouse` composition | Platform service | Sole host-neutral platform reference-processing and documentation-evidence facade over authorized source capabilities, exact-target pruning evidence, Metadata-owned forwarding, reference XML, and implementation PDB/SourceLink correspondence. | [PlatformHouse reference processing](design/platform-house-reference-processing.md), [#6301](https://github.com/richlander/dotnet-inspect/issues/6301), [#6375](https://github.com/richlander/dotnet-inspect/issues/6375) |
