...
| `DotnetInspector.ResearchSections` | Optional L2 companion | Completed Research-backed inspections that pair owner-issued Documents with the shared inspection envelope without inverting the L1 dependency graph. | [Implementation Diff](design/implementation-diff.md#exact-pair-document-and-inspection-envelope), [Multi-part inspection documents](design/multi-part-inspection-documents.md) |
