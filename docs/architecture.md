...
| Target `PlatformHouse` composition | Platform service | Sole host-neutral platform target/version settlement, realization, reference-processing, and documentation-evidence facade over authorized capabilities, with provenance-retaining bare-library handoff, Metadata-owned forwarding, reference XML, and implementation PDB/SourceLink correspondence. Package pruning remains upstream in the package domain. | [PlatformHouse realization and reference processing](design/platform-house-reference-processing.md), [#6301](https://github.com/richlander/dotnet-inspect/issues/6301), [#6375](https://github.com/richlander/dotnet-inspect/issues/6375) |
