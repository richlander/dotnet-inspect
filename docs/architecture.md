...
| `Inspector.Resources` | Resource protocol floor | Dependency-free current-C# resource declarations plus the serializer-neutral synchronous snapshot callback and ref-like view shared by resource owners and Analysis. | [Resource ownership and borrowing](design/resource-ownership-and-borrowing.md), [#6544](https://github.com/richlander/dotnet-inspect/issues/6544) |
