...
| Target `PlatformHouse` composition | Platform service | Sole host-neutral platform reference-processing facade over authorized source capabilities, exact-target pruning evidence, and Metadata-owned forwarding. | [PlatformHouse reference processing](design/platform-house-reference-processing.md), [#6301](https://github.com/richlander/dotnet-inspect/issues/6301) |
