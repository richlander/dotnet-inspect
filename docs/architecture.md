...
| `DotnetInspector.DocumentationHouse.Contracts` | Documentation service contract | Source-neutral exact subjects, compiled-XML contributions, finite operation plans, typed attempts and outcomes, work evidence, and resource-free receipts. | [DocumentationHouse composition](design/documentation-house.md), [#6579](https://github.com/richlander/dotnet-inspect/issues/6579) |
