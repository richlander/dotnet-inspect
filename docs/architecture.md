...
| `ILInspector.SourceLink` | Source interpreter and composer | SourceLink map matching, provenance grammar, extraction, canonical paths, URL decoration, source correlation, source Findings, and supplied-source checksum verification and decoding. | [PDB acquisition](pdb-acquisition.md), [source Finding producers](design/source-finding-producers.md) |
