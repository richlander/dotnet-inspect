...
| `Inspector.Resources` | Resource protocol floor | Dependency-free current-C# declaration carriers plus the serializer-neutral synchronous snapshot callback and ref-like view shared by resource owners and Analysis. The non-normative type map records each owner's current adoption without redefining it. | [Resource ownership and borrowing](design/resource-ownership-and-borrowing.md), [resource-owner type map](design/resource-owner-type-map.md), [Resource Effect Language](design/resource-effect-language.md), [#6544](https://github.com/richlander/dotnet-inspect/issues/6544) |
