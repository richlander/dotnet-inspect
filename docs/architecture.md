...
| `inspect-web/` | Product host | Top-level Browser/Wasm product workspace containing the host, UI, focused managed facades, tests, canaries, and deployment tooling. | [Inspect Web UI](design/inspect-web-ui.md) composition map, [navigation presentation](design/inspect-web-navigation-presentation.md), [operation authority](design/inspect-web-operation-authority.md) |
