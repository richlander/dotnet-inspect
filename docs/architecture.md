...
| `DotnetInspector.Libraries` | Library content contract | Successful source-ready handoff binding one Metadata-projected assembly and optional companion PDB candidate to guarded retained content, provenance, generation, and lease validity without paths or reacquisition. | [Source-ready library representation](design/source-ready-library.md), [#6512](https://github.com/richlander/dotnet-inspect/issues/6512) |
