...
type-relationship row vocabulary and host-neutral Dependency content, plus the
bounded Resource Explanation graph and completed-inspection envelope used to
explain exact product resources without acquisition. Current L2 section
