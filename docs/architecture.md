...
| Target `DotnetInspector.Libraries` | Managed-Library resource owner | Resource-free exact-Library and content-role references, aggregate content ownership, owner-issued operation leases, and synchronous scoped multi-content borrowing shared by PackageHouse, PlatformHouse, Workspace, SourceHouse, and DocumentationHouse. | [Library ownership and borrowing](design/library-ownership-and-borrowing.md), [resource ownership and borrowing](design/resource-ownership-and-borrowing.md), [#6621](https://github.com/richlander/dotnet-inspect/issues/6621) |
