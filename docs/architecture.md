...
| Target `DotnetInspector.Platforms` contract floor | Platform identity | Package-neutral logical family and exact family-target currency shared by declarations, source composition, pruning, workspaces, CLI, and Browser/Wasm. | [Platform target currency](design/platform-target-currency.md), [#6361](https://github.com/richlander/dotnet-inspect/issues/6361) |
