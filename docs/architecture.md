...
| `DotnetInspector.PlatformHouse.Execution.Packages` | Package-backed platform execution | Host-neutral composition that selects successful package-backed reference/runtime snapshots and exact package authority, producer, content-generation, origin, coordinate, and digest provenance for the shared bounded Artifact and Library handoff. One-Library and reference-only, implementation-only, or paired complete-population results return Library and Artifact authorities separately. It also adapts an authoritative package-backed one-assembly reference snapshot to the source-neutral non-owning binding executor after Package Source settlement, preserving full package provenance while delegating all temporary authority, cleanup, and receipt work. Single-view populations preserve source order; implementation-only members receive both roles under Platform-owned declaration-surface evidence; paired populations preserve independently authoritative membership as an exact-identity reference-first lossless union. Every population retains detached Package Source lifetime. Target selection, terminal source-attempt settlement, and host wiring remain staged. | [PlatformHouse realization and reference processing](design/platform-house-reference-processing.md), [package-backed Platform realization](design/package-backed-platform-realization.md), [#7304](https://github.com/richlander/dotnet-inspect/issues/7304), [#7383](https://github.com/richlander/dotnet-inspect/issues/7383), [#7395](https://github.com/richlander/dotnet-inspect/issues/7395), [#7457](https://github.com/richlander/dotnet-inspect/issues/7457), [#7626](https://github.com/richlander/dotnet-inspect/issues/7626) |
