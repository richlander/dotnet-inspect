...
| Raw metadata | `library -S @Metadata`, `--heap "#Strings:0x1a4"`, `--metadata-root r2r-manifest` | Decoded ECMA-335 tables and heaps, explicit R2R manifest roots, and `Metadata: ReadyToRun` envelope facts. |
