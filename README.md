...
| `depends X` | Walk type, package, or library dependency graphs. One logical edge is one row across the default Markdown tree, standalone `--tree`, Mermaid, tables, TSV, JSONL, JSON, row windows, and counts. |
