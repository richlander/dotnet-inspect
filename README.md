...
| `body-shape X` | Search one library for an exact stable rendered body-syntax kind, returning the containing member, MethodDef token, exact range, and selected text. |
