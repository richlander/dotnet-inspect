# Performance Triage run: AutoMapper@16.1.1 — dotnet-inspect 0.16.0
...
```bash
dnx dotnet-inspect@0.16.0 -y -- library AutoMapper@16.1.1 -S "Performance Triage" --top 25
dnx dotnet-inspect@0.16.0 -y -- library AutoMapper@16.1.1 -S "Performance Triage" --loop --min-confidence high --top 25
dnx dotnet-inspect@0.16.0 -y -- library AutoMapper@16.1.1 -S "Performance Triage"   # full, for row tallies
dnx dotnet-inspect@0.16.0 -y -- library AutoMapper@16.1.1 -S "Performance Triage" --triage-shape async-state-machine,materialize-in-loop --top 25
```
...
Identical to 0.15.0 — same total, shapes, and confidence mix; no escape-gate
removals and no new shapes fired. The one high-confidence `AddMapsCore`
candidate is preserved. A neutral run: no regression, no visible improvement on
this library.
