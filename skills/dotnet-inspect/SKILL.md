...
| Compare APIs or implementations | `diff --package Foo@old..new --breaking` (`--additive` new APIs); `match Type.MethodA Type.MethodB --package Foo` compares two methods in one retained assembly. |
