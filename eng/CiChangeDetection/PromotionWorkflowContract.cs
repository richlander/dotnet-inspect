...
internal static class PromotionWorkflowContract
{
    ...
    private const string CompilerAsyncDeploymentCheck =
        ...
        eng/verify-inspect-web-async-deployment.sh \
          compiler \
          prototypes/inspect-web/DotnetInspect.Web/bin/Release/net11.0/DotnetInspect.Web.dll \
    ...
    internal static void AssertMutations(string repository)
    {
        ...
        AssertMutationRejected(
            stagingWorkflow,
            "prototypes/inspect-web/DotnetInspect.Web/bin/Release/net11.0/DotnetInspect.Web.dll",
            "prototypes/inspect-web/DotnetInspect.Web/obj/Release/net11.0/linked/DotnetInspect.Web.dll",
            ValidateStaging,
    ...
    private static void ValidateStaging(string workflow)
    {
        ...
        const string ExpectedPublish =
            ...
            dotnet publish \
              prototypes/inspect-web/DotnetInspect.Web/DotnetInspect.Web.csproj \
              -c Release \
